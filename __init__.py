...
from .boyo_mask_normalise import NODE_CLASS_MAPPINGS as mask_norm_mappings
from .boyo_mask_normalise import NODE_DISPLAY_NAME_MAPPINGS as mask_norm_display_mappings
from .boyo_pid_aspect import NODE_CLASS_MAPPINGS as PID_ASPECT_CLASSES, NODE_DISPLAY_NAME_MAPPINGS as PID_ASPECT_NAMES
from .boyo_experimental_sigma_plot import NODE_CLASS_MAPPINGS as EXP_SIGMA_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as EXP_SIGMA_DISPLAY_NAME_MAPPINGS
from .boyo_experimental_solver_switch import NODE_CLASS_MAPPINGS as EXP_SOLVER_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as EXP_SOLVER_DISPLAY_NAME_MAPPINGS
from .boyo_experimental_richardson import NODE_CLASS_MAPPINGS as EXP_RICH_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as EXP_RICH_DISPLAY_NAME_MAPPINGS
from .boyo_debug_sampler import NODE_CLASS_MAPPINGS as DEBUG_SAMPLER_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as DEBUG_SAMPLER_DISPLAY_NAME_MAPPINGS
from .boyo_debug_sigmas import NODE_CLASS_MAPPINGS as DEBUG_SIGMAS_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as DEBUG_SIGMAS_DISPLAY_NAME_MAPPINGS
from .boyo_line_text_nodes import NODE_CLASS_MAPPINGS as LINE_TEXT_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as LINE_TEXT_DISPLAY_NAME_MAPPINGS
from .boyo_h3_trigger_injector import NODE_CLASS_MAPPINGS as H3TRIGGER_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as H3TRIGGER_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(mask_norm_mappings)
NODE_CLASS_MAPPINGS.update(PID_ASPECT_CLASSES)
NODE_CLASS_MAPPINGS.update(EXP_SIGMA_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(EXP_SOLVER_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(EXP_RICH_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(DEBUG_SAMPLER_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(DEBUG_SIGMAS_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(LINE_TEXT_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(H3TRIGGER_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(mask_norm_display_mappings)
NODE_DISPLAY_NAME_MAPPINGS.update(PID_ASPECT_NAMES)
NODE_DISPLAY_NAME_MAPPINGS.update(EXP_SIGMA_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(EXP_SOLVER_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(EXP_RICH_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(DEBUG_SAMPLER_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(DEBUG_SIGMAS_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(LINE_TEXT_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(H3TRIGGER_DISPLAY_NAME_MAPPINGS)
