...
class BoyoAssetGrabberSimple:
    ...
    def download_assets(self, json_file_path: str, download_trigger: bool) -> Tuple[str]:
        ...
        try:
            ...
            status = self._process_manifest(manifest, comfyui_root)
            self.downloading = False
    ...
    def _process_manifest(self, manifest: Dict[str, Any], comfyui_root: str) -> str:
        ...
        if "custom_nodes" in manifest:
            ...
            node_results = self._download_custom_nodes(manifest["custom_nodes"], comfyui_root)
        ...
        if "models" in manifest:
            ...
            model_results = self._download_models(manifest["models"], comfyui_root)
    ...
    def _download_custom_nodes(self, nodes: List[Dict[str, str]], comfyui_root: str) -> List[str]:
    ...
    def _download_models(self, models: Dict[str, List[Dict]], comfyui_root: str) -> List[str]:
        """Download model files"""
        results = []
        models_base_path = os.path.join(comfyui_root, "models")
