...
app.registerExtension({
  name: "BoyoPromptRelay.Timeline",

  async beforeRegisterNodeDef(nodeType, nodeData) {
    if (nodeData?.name !== "BoyoPromptRelayEncodeTimeline") return;
    ...
    nodeType.prototype.onNodeCreated = function () {
      ...
      this._timelineWidget = this.addDOMWidget("boyo_prompt_relay_timeline", "BoyoPromptRelayTimeline", container, {
        serialize: false,
        hideOnZoom: false,
        getMinHeight: () => 220,
        getHeight: () => 220,
      ...
      setTimeout(() => {
        try {
          ...
          console.error("[BoyoPromptRelay] timeline editor init failed:", err);
        }
      }, 0);
